...
static inline void* memset_slow(void* addr, size_t val, size_t len) {
	byte* p = (byte*)addr;
...
static inline void* memcpy_slow(void* dest, const void* src, size_t len) {
	byte* p;
...
static inline size_t strcmp_slow(const byte* s1, const byte* s2) {
	int32 r, c1, c2;
...
static inline size_t memcmp_slow(const void* p1, const void* p2, size_t len) {
	int32 r, i;
...
static inline size_t strlen_slow(const byte* p) {
	int32 len = 0;
...
static inline size_t strncmp_slow(const byte* s1, const byte* s2, size_t len) {
	int32 r, c1, c2;
...
static inline void* memset_builtin(void* addr, int val, size_t len) {
	return __builtin_memset(addr, val, len);
}

static inline void* memcpy_builtin(void* dest, const void* src, size_t len) {
	return __builtin_memcpy(dest, src, len);
}

static inline size_t strcmp_builtin(const byte* s1, const byte* s2) {
	return __builtin_strcmp(s1, s2);
}

static inline size_t memcmp_builtin(const void* p1, const void* p2, size_t len) {
...
static inline size_t strlen_builtin(const byte* p) {
	return __builtin_strlen(p);
}

static inline size_t strncmp_builtin(const byte* s1, const byte* s2, size_t len) {
